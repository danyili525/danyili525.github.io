...
<header class="page-heading">
  <p class="page-heading__eyebrow">Research</p>
  <h1>Publications</h1>
  <p class="lead">
    This page follows a clean academic-publication layout inspired by the reference you shared. Replace the sample entries below with your own published papers, working papers, reports, posters, and supporting links.
  </p>
</header>
...
<section class="publication-section">
  ...
  <article class="publication-item">
    ...
    <div class="publication-item__content">
      <h3><a href="#">Title of your first publication goes here</a></h3>
...
<section class="publication-section">
  ...
  <article class="publication-item publication-item--compact">
    <div class="publication-item__content">
      <h3><a href="#">Title of your working paper goes here</a></h3>
      <p class="publication-item__authors"><strong>Danyi Li</strong>, Coauthor Name</p>
...
<section class="publication-section">
  ...
  <article class="publication-item publication-item--compact">
    <div class="publication-item__content">
      <h3>Project title or manuscript title</h3>
      <p class="publication-item__summary">
  ...
  <article class="publication-item publication-item--compact">
    <div class="publication-item__content">
      <h3>Another ongoing project title</h3>
      <p class="publication-item__summary">
